...
| Main MCU | STM32H563 | package, pin/timer/CAN-FD budget, programming fixture | interface loopback and reset capture | Electrical/Firmware |
...
| Jetson branch | 12 V eFuse, >=6 A class | exact MPN, current limit and thermal fit | load-trip and brownout test | Electrical |
