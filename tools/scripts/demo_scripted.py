...
def _utc_wall_clock_now() -> str:
    """Read the real wall clock at the verification boundary.

    Verification metadata must describe when the claim was checked; a fixed
    placeholder would make freshness and ordering policies unusable.
    """
